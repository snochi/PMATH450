...
\begin{document}
    ...
    \begin{proof}
        ...
        Now note that
        \begin{flalign*}
            && \lambda_{\op}\left( \trim_{\varep}\left( A \right) \right) & = \sum^{n}_{j=1} \lambda_{\op}\left( \trim_{\frac{\varep}{n}}\left( A_j \right) \right) = \sum^{n}_{j=1} \left(\lambda_{\op}\left( A_j \right)-\frac{\varep}{n}\right) = \left( \sum^{n}_{j=1}\lambda_{\op}\left( A_j \right) \right)-\varep && \\
